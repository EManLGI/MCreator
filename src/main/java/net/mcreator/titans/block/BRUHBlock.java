...
package net.mcreator.titans.block;
...
public class BRUHBlock extends TitansModElements.ModElement {
	@ObjectHolder("titans:bruh")
	public static final Block block = null;
	public BRUHBlock(TitansModElements instance) {
		super(instance, 1);
	}
